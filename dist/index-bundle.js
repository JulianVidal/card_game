...
a {
    ...
    font-size: min(6vw, 6vh, 30px);

    display: flex;
    justify-content: center;
    align-items: center;
}
`, "",{"version":3,"sources":["webpack://./src/index.css"],"names":[],"mappings":"AAAA;IACI,WAAW;IACX,YAAY;CACf,yBAAyB;IACtB,uBAAuB;;IAEvB,aAAa;IACb,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,iBAAiB;IACjB,uBAAuB;IACvB,mBAAmB;;IAEnB,UAAU;IACV,WAAW;;IAEX,SAAS;AACb;;AAEA;IACI,WAAW;IACX,iBAAiB;;IAEjB,gBAAgB;IAChB,iBAAiB;;IAEjB,eAAe;;CAElB,yBAAyB;CACzB,cAAc;IACX,kBAAkB;IAClB,qBAAqB;IACrB,8BAA8B;;IAE9B,aAAa;IACb,uBAAuB;IACvB,mBAAmB;AACvB","sourcesContent":["html {\n    width: 100%;\n    height: 100%;\n\tbackground-color: #E0F0E0;\n    font-family: sans-serif;\n\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\n\nbody {\n    display: flex;\n    flex-direction: column;\n    flex-wrap: nowrap;\n    justify-content: center;\n    align-items: center;\n\n    width: 80%;\n    height: 80%;\n\n    margin: 0;\n}\n\na {\n    height: 70%;\n    aspect-ratio: 7/2;\n\n    max-width: 400px;\n    max-height: 100px;\n\n    margin: 1vw 1vh;\n\n\tbackground-color: #197BBD;\n\tcolor: #E0F0E0;\n    text-align: center;\n    text-decoration: none;\n    font-size: min(6vw, 6vh, 30px);\n\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\n"],"sourceRoot":""}]);
// Exports
