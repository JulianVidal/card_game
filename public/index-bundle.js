...
const offerQR = document.getElementById("offer-qr-button");
const answerQR = document.getElementById("answer-qr-button");
offerQR.onclick = () => { qr("offer"); };
answerQR.onclick = () => { qr("answer"); };
function qr(type) {
    const box = document.getElementById(type + "-box");
    videoElement.style.display = "";
    const qrScanner = new qr_scanner_1.default(videoElement, result => {
...
function createQRCode(data, elId) {
