...
exports.handleDCOpen = exports.handleDCMessage = void 0;
...
exports.handleDCMessage = handleDCMessage;
;
...
exports.handleDCOpen = handleDCOpen;
;
...
const qrcode_1 = __webpack_require__(/*! ./qrcode */ "./src/qrcode.ts");
const answer_1 = __webpack_require__(/*! ./answer */ "./src/answer.ts");
let pc;
let dataChannel;
const servers = {
    iceServers: [
...
function createPeerConnection() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        dataChannel.onmessage = answer_1.handleDCMessage;
        dataChannel.onopen = answer_1.handleDCOpen;
        dataChannel.onclose = handleClose;
        dataChannel.onerror = handleError;
        pc.ondatachannel = function (event) {
            const receive = event.channel;
            receive.onmessage = answer_1.handleDCMessage;
            receive.onopen = answer_1.handleDCOpen;
