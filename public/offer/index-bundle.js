...
function createConnection() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        ;
        const { pc } = yield (0, webrtc_1.createOffer)(handleOpen);
        let connectionResolve;
        (0, qrcode_1.readQrCode)((scanner, data) => {
            var _a;
            scanner.stop();
            (_a = document.querySelector("#qr>svg")) === null || _a === void 0 ? void 0 : _a.remove();
            videoEl.style.display = "none";
            (0, webrtc_1.addAnswer)(data, pc);
        }, videoEl);
        window.addEventListener("message", ({ data }) => {
            console.log("Received From iframe", data);
            const [connection, msg] = data.split(/ (.*)/s);
            (0, webrtc_1.sendMessage)(msg, connections[parseInt(connection)].dc);
        });
